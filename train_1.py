...
YOUR_ACCESS_TOKEN = '78452434-cf52-49fd-b1b9-e404d543aa9e'
...
def train(
    ...
    for idx in pbar:
        ...
        fused_ab = pixel_attention(fake_swap_ab, pretrained_ab)
            ...
            if i % 500 == 0:
                with torch.no_grad():
                    ...
                    for inum in range(10):
                        ...
                        pretrained_ab = pretrained_ab.to(fake_swap_ab.device)
                        val_fused_ab = pixel_attention(fake_swap_ab, pretrained_ab)
