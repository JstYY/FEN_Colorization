...
if __name__ == "__main__":
    ...
    model_name = 'Color2Embed_C_9.5w'
    ckpt_path = 'experiments/Color2Embed_1/095000.pt'
    ...
    for i in range(imgs_num):
        ...
        with torch.no_grad():
            ...
            fake_ab = F.interpolate(fake_ab * 110, size=(height, width), mode='bilinear', recompute_scale_factor=False,
                                    align_corners=False)
